...
namespace ACME_Web_App
{
    public class MasterProductList
    {
      ...
      public static List<MasterProductList> MPL = new List<MasterProductList>();
        ...
        //     return status;
        // }
 // Method to return formatted string of attributes
        ...
        public static void UpdateMPL()
        {
            ...
            MPL.Add(product = new MasterProductList(false, "", "BVSELZRVARIETY 2/12 CAN", "ANHEUSER-BUSCH", "B&V SPIKED SELTZER"));
            MPL.Add(product = new MasterProductList(false, "", "BVSELZRVARIETY SLEEK SC", "ANHEUSER-BUSCH", "B&V SPIKED SELTZER"));
            MPL.Add(product = new MasterProductList(false, "", "BV BLEND VAR 2/12 CAN", "ANHEUSER-BUSCH", "B&V SPIKED SELTZER"));
            MPL.Add(product = new MasterProductList(false, "", "BVSELZRBLKCHRY 24/16 6/4CAN", "ANHEUSER-BUSCH", "B&V SPIKED SELTZER"));
